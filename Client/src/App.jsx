  ...
  return (
    <>
      ...
      <div >
        ...
        <button onClick={addDish} className='bg-green-400 mt-2 -ml-2 h-8 rounded-lg w-80 lg:w-96 lg:h-10 shadow-2xl font-medium text-white hover:bg-green-500 focus:transition-colors duration-300 active:bg-green-600 active:scale-95'>Add Item</button>
